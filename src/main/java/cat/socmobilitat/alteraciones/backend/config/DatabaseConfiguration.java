...
@Configuration
@EnableJpaRepositories("cat.socmobilitat.alteraciones.backend.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("cat.socmobilitat.alteraciones.backend.repository.search")
